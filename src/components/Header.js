...
const Header = () => {
    ...
    <div>
      <div className="flex flex-row">
        <div className="navbar bg-gray-700 navbar-expand-lg shadow-md py-2 relative flex items-center w-full justify-between">
          <Link to="/home">
            <img
              className="mt-3 ml-3 h-full w-40 md:h-30 md:w-30"
 ...
 <div className="flex items-center relative mr-20">
  ...
  {/* <!-- Icon --> */}
  <Link className="text-gray-500 hover:text-gray-700 focus:text-gray-700 mr-4" to="/home">
  ...
  <div className="dropdown relative">
    <Link className="
          ...
          hidden-arrow
          flex items-center
        " to="/home" id="dropdownMenuButton1" role="button" data-bs-toggle="dropdown" aria-expanded="false">
  ...
  <div className="dropdown relative">
    <Link className="dropdown-toggle flex items-center hidden-arrow" to="/" id="dropdownMenuButton2" role="button"
      ...
      <img src="" className="rounded-full h-25 W-25"
        alt=""  />
    </Link>
    <ul className="
    dropdown-menu
  ...
  " aria-labelledby="dropdownMenuButton2">
      ...
      <li>
        ...
        text-gray-700
        hover:bg-gray-100
      " to="/home">Something else here</Link>
      </li>
    </ul>
  </div>
  </div>

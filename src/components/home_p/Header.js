  ...
  return (
    <div>
      <div className="flex bg-red-500">
        <div className="navbar navbar-expand-sm  py-4 relative flex items-center w-full justify-between">
          <Link to="/home">
            <img
          ...
          <input
            type="search"
            className="  ml-20 flex-auto  px-3 py-1.5 text-base font-normal

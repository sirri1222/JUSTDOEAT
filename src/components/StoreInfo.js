  ...
  return (
    <div>
      <div className=" bg-white border border-gray-200 p-2">
        <div className="p-3 border-dotted border-b border-gray-500 ">
          <img src="photo/bell.PNG"></img>
          <p className="text-xs">
      ...
      <div className=" bg-white border border-gray-200 p-2">
        <div className="p-3 border-dotted border-b border-gray-500 ">
          <img src="photo/store.PNG"></img>
          <p className="text-xs">
            <span className=" text-gray-500">상호명</span> |
            주식회사케이에프씨코리아
            <br />
            <span className=" text-gray-500">사업자등록번호</span> | 201-81-89723
          </p>
        </div>
      </div>
    </div>

...
const HeaderBottom = () => {
  return (
    <div> 
      {/* <!-- Background image --> */}
    <div className="relative overflow-hidden bg-no-repeat bg-cover h-35" 
    ><img src='/photo/chicken.png' alt='치킨'></img>
      <div className="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed bg-gray-500/40">

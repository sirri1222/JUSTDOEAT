      ...
      <div>
        <div className="flex justify-center">
          <div className="rounded-lg shadow-lg bg-white max-w-4xl">
            ...
            <div className="p-6">
              <h5 className="text-gray-900 text-xl text-center font-medium mx-auto mb-10">
                {" "}
         ...
         bg-gray-600
          text-white font-medium text-xs leading-tight uppercase rounded shadow-md
           hover:bg-gray-700 hover:shadow-lg focus:bg-gray-700 focus:shadow-lg
            focus:outline-none focus:ring-0 active:bg-gray-800 active:shadow-lg transition duration-150 ease-in-out"
                >
                  로그인하러 가기
                </button>
              </Link>
